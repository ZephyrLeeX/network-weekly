...
from backend.web.pages import home_page, login_page
from backend.web.security import (
    CSRF_COOKIE_NAME,
    csrf_for_render,
    csrf_guard,
    issue_csrf_token,
...
async def login_submit(request: Request) -> Response:
    ...
    set_csrf_cookie(redirect, issue_csrf_token())  # rotate at privilege change
    return redirect
