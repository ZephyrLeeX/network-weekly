...
**Engineering side ready (2026-09-06):** W05-T001–T004 REVIEW_PASSED on work/wave-05 (production layout, install.sh, update.sh, logging/retention/runbook); acceptance procedure and evidence tooling ready per docs/ACCEPTANCE.md (A01–A16); W05-AUDIT REVIEW_PASSED (heartbeat verifier, retention evidence, rollback guidance fixes re-tested green, alembic head 0011 unchanged).
